...
uint16_t half_convert_v0( int32_t i );
...
test_div( void ) 
{
    ...
    // for ( i=0; i < 16; i++ )
    {
      ...
      test_f_a = float_test_vector_med[ (float_test_vector_count-1) - i ];
      test_f_b = float_test_vector_med[i];
      // fa.f32 = 8.0;
      // fb.f32 = 16.25;
      // test_f_a = fa.u32;
      // test_f_b = fb.u32;
      ...
      test_h_a = half_from_float( test_f_a );
      test_h_b = half_from_float( test_f_b );
      test_h_c = half_div( test_h_a, test_h_b );
